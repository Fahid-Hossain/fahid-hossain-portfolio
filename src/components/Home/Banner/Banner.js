        ...
        <div id="home" className="mt-5">
            ...
            <div className="row align-items-start">
                <div data-aos="flip-left" className="col-12 col-md-6 banner">
                    ...
                    <a href="https://drive.google.com/file/d/169fA27isTLumEzJI74cQ3TNtJeJ0Rj9X/view?usp=sharing" download="https://drive.google.com/file/d/169fA27isTLumEzJI74cQ3TNtJeJ0Rj9X/view?usp=sharing"><button className="btn btn-outline-warning">Get Resume</button></a>
